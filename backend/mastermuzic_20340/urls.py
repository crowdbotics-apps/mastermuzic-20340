"""mastermuzic_20340 URL Configuration
...
admin.site.site_header = "MasterMuzic"
admin.site.site_title = "MasterMuzic Admin Portal"
admin.site.index_title = "MasterMuzic Admin"

# swagger
api_info = openapi.Info(
    title="MasterMuzic API",
    default_version="v1",
    description="API documentation for MasterMuzic App",
)
